...
public class Main {
  public static void main(String[] args) {
    ...
    System.out.println(no1.getProximoNo()); // 2
    System.out.println(no1.getProximoNo().getProximoNo()); // 3
    System.out.println(no1.getProximoNo().getProximoNo().getProximoNo()); // 4
